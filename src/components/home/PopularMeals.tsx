    ...
    return (
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">Popular in Your Area</h2>
          <p className="text-muted-foreground text-center mb-12">Homemade favorites from chefs near you</p>
    ...
    <section className="py-16 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-center">Popular in Your Area</h2>
        </div>
        <p className="text-muted-foreground text-center mb-12">Homemade favorites from chefs near you</p>
          ...
          {meals.map((meal) => (
            ...
            >
              <div className="aspect-video bg-muted relative overflow-hidden">
                ...
                <Badge className="absolute top-2 right-2">{meal.category}</Badge>
              </div>
        ...
        <div className="text-center mt-10">
          <Button size="lg" variant="outline" onClick={() => navigate("/meals")}>
            View All Meals
          </Button>
        </div>
      </div>
