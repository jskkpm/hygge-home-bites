    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="text-center">
          ...
          <DialogTitle className="text-2xl">Sign up to order homemade meals near you!</DialogTitle>
          <DialogDescription className="text-base pt-2">
            Join MyHomePlate to enjoy authentic home-cooked Indian dishes from verified local chefs.
          </DialogDescription>
        </DialogHeader>
